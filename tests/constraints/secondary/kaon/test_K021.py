...
def test_lfv_live_toy_matches_independent_rate_and_mkk_scaling():
    ...
    assert low.diagnostics["neutral_mode"] is True
    assert low.diagnostics["klong_mass_gev"] == pytest.approx(0.497611)
    assert low.diagnostics["pi0_mass_gev"] == pytest.approx(0.1349768)
