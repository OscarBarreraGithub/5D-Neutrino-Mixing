...
| W2-P4 | Lepton NC. **PLAN DUAL-APPROVED** (both arbitrations resolved from repo: lepton a_ref SHARED=EW-universal a(0.65); heavy neutral-vector DEFERRED includes_heavy_neutral_exchange=False; U_e=I diagonal lepton fit; νν LH-current pinned). Sub-steps 4a builder/lepton-Z/contacts(no rewire) → 4b Z-LFV(T015/16/17) → 4c LFV-rare(K019-21,C006/08)+L002/L009+μ-e-conv(L003/04/05) → 4d νν(B022/23,K004/05). **4a IMPL IN FLIGHT.** | plan dual ✅ | 4a in flight | — |
