...
| W2-P5 | Charged-current. **PLAN DUAL-APPROVED** (gate: B025 dual-ratified FULL→PARTIAL [scalar/RH/FF not built] correcting count 26→25; eta_W eigenvector-pinned sign; shared a_ref reuse; exact NN roots+zero mode). Sub-steps 5a builder(W mass-matrix/W',δG_F,charged contacts; no rewire) → 5b EW002/K018/K017/B009/B025 → 5c EW003 covariance. **5a IMPL IN FLIGHT.** | plan dual ✅ | 5a in flight | — |
