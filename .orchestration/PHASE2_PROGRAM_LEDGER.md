...
| W2-P3 | Quark NC (point_builder ext + quark Z-matrices/contacts + rewire Z-pole/FCNC-Z/rare-B-K-charm vector). **PLAN DUAL-APPROVED** (gate caught lepton-side undercount + raw-overlap-vs-coupling-shift prefactor). Sub-steps: 3a builder/matrices/contacts (no rewire) → 3b Z-pole → 3c FCNC-Z → 3d rare B/K/charm. **3a IMPL IN FLIGHT.** | plan dual ✅ | 3a in flight | — |
