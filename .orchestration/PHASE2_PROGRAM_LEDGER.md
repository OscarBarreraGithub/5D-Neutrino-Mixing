...
| W2-P3 | Quark NC. PLAN dual-approved. **3a** builder/quark-Z/contacts `7813e6c` (dual ✅, 1st-try); **3b** Z-pole T010/T011(PARTIAL Zbb)/T012 `7c0ecff` (dual ✅); **3c** FCNC-Z T014 `651389e` (dual ✅). **3d** rare B/K/charm split into 3d-B/3d-K/3d-C — **3d-B (rare-B) IMPL IN FLIGHT** (`bpcayesyw`). | plan dual ✅ | 3a/3b/3c dual ✅ | 7813e6c/7c0ecff/651389e |
