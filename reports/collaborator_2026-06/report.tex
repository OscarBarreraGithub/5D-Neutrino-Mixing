...
anarchic-forward mode. Grey, blue and orange all come from one dense single
ensemble, so the cloud is continuous and de-banded.}
\end{figure}
...
The grey/blue/orange points and the 5/50/95\% quantiles are now drawn from a
SINGLE dense ensemble (the 202{,}500-draw \texttt{anarchic\_bauer\_s1\_zbb} run on
a fine 45-tile 1--20~TeV grid: 22{,}880 mass+CKM-gated grey, 5{,}401
$Z\to b\bar b$-passing blue, ${\sim}5{,}000$ in-window orange), so the cloud is
continuous and de-banded (no per-tile striping). One honest, real difference (not
