...
PAPER_0710_1869_DELTAF2_RG_LR_BASIS_STATUS_INACTIVE_ID = (
    "paper_q4q5_to_bmu_lr_basis.map_frozen.lr_running_inactive.v2"
)
PAPER_0710_1869_DELTAF2_RG_LR_BASIS_STATUS_ACTIVE_ID = (
    "paper_q4q5_to_bmu_lr_basis.map_frozen.lr_rg_active.custom_lr_hadronic_active.custom_lr_only_observable_active.custom_combined_observable_active.default_export_q1_only.v6"
)
...
PAPER_0710_1869_DELTAF2_RG_LR_RUNNING_BRIDGE_ID = (
    "paper_o4o5_to_bmu_q1lrq2lr.lo_conjugated_running.v1"
)
...
PAPER_0710_1869_DELTAF2_RG_SUPPORTED_OPERATOR_SUBSET_ID = (
    "paper_basis.q1_vll_q1_vrr_q4_lr_q5_lr.rg_supported.lo.v2"
)
