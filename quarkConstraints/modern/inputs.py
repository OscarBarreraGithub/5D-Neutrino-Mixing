...
def default_modern_default_neutral_meson_inputs() -> tuple[ModernDefaultNeutralMesonInput, ...]:
    ...
    return (
        ...
        ModernDefaultNeutralMesonInput(
            system_id="B_d",
            observable_kind="non_cp_mixing_amplitude_hadronic",
            backend_key="b_d",
        ...
        ModernDefaultNeutralMesonInput(
            system_id="D0",
            observable_kind="conservative_non_cp_mixing_amplitude_hadronic",
            backend_key="d",
            ...
            generations=(0, 1),
            bound=3.125e-15,
            note="D0 mixing evaluated with proper hadronic matrix elements (FLAG 2024 / HFLAV).",
        ),
    )
