...
def build_from_rs_ew_inputs(
    ...
    *,
    ...
    qL_rep: str = "all_gen_Q_L_bidoublet_(2,2)_{2/3}",
    tR_rep: str = "t_R_singlet_(1,1)_{2/3}",
    bR_rep: str = "b_R_elementary",
    protect_scope: Any = "all_gen_down_left_diagonal",
    bR_strategy: str = "elementary_zero",
    kappa_b: float = 0.0,
