...
_CUSTODIAL_VARIANT_ACTIVE_NOTE = (
    ...
    "from rs_ew_couplings metadata; top-partner loop components are reported "
...
def _rs_zbb_matching_diagnostics(source: Any | None) -> dict[str, Any]:
    ...
    for key in (
        ...
        "custodial_omissions",
        "custodial_omission_details",
        "SU2_R_tower",
        "custodian_spectrum",
        "exact_NC_mixing",
        "BKT",
        "custodian_spectrum_inferred",
        "exact_top_partner_mass_matrix_included",
        "brane_kinetic_terms_included",
        "full_Teq_Zbbeq_loop_matching_included",
        "M_KK_convention",
    ...
    def _unevaluated_result(self, diagnostics: Mapping[str, Any]) -> ConstraintResult:
        return ConstraintResult(
            ...
            diagnostics={
                ...
                "passes_semantics": (
                    "non-vetoing only; no Zbb minimal-RS tree NP prediction was evaluated"
                ),
