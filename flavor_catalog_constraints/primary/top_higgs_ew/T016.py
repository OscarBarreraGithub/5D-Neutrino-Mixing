...
``rs_ew_couplings.z_delta_g_L/R_e[0,2]`` and is rigorous within the Phase-4
...
_NEEDS_HUMAN_PHYSICS = (
    ...
    "rs_ew_couplings.z_delta_g_L/R_e[0,2]; with the v1 diagonal "
...
class Constraint:
    ...
    def evaluate(self, point: ParameterPoint) -> ConstraintResult:
        ...
        try:
            delta_g_left = _coupling_entry(rs_ew_couplings, "z_delta_g_L_e", 0, 2)
            delta_g_right = _coupling_entry(rs_ew_couplings, "z_delta_g_R_e", 0, 2)
        ...
        return ConstraintResult(
            ...
            notes=(
                ...
                "rs_ew_couplings.z_delta_g_e[0,2] entry; loop-induced Z-LFV "
