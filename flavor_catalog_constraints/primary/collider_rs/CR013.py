"""CR013 - Diphoton high-mass spin-0/2 resonance (placeholder)."""
    ...
    if isinstance(raw, dict):
        for v in raw.values():
            ...
            if isinstance(v, list) and v and isinstance(v[0], dict):
                inner = v[0]; break
    obs = str(inner.get("observable", "Diphoton high-mass spin-0/2 resonance")) if isinstance(inner, dict) else "Diphoton high-mass spin-0/2 resonance"
...
class Constraint:
    ...
    observable = "Diphoton high-mass spin-0/2 resonance"
    ...
    def evaluate(self, point: ParameterPoint) -> ConstraintResult:
        result = evaluate_collider_rs_placeholder("diphoton resonance")
        return ConstraintResult(
            ...
            notes="Evaluation deferred: CR013 requires direct-search recast machinery not in core.",
