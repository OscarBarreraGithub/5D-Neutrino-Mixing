"""CR014 - Four-top-quark production (placeholder)."""
    ...
    if isinstance(raw, dict):
        for v in raw.values():
            ...
            if isinstance(v, list) and v and isinstance(v[0], dict):
                inner = v[0]; break
    obs = str(inner.get("observable", "Four-top-quark production")) if isinstance(inner, dict) else "Four-top-quark production"
...
class Constraint:
    ...
    observable = "Four-top-quark production"
    ...
    def evaluate(self, point: ParameterPoint) -> ConstraintResult:
        result = evaluate_collider_rs_placeholder("4-top")
        return ConstraintResult(
            ...
            notes="Evaluation deferred: CR014 requires direct-search recast machinery not in core.",
