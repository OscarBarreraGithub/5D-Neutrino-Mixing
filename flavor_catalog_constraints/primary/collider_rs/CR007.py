"""CR007 - KK graviton spin-2 Bulk-RS (placeholder)."""
    ...
    if isinstance(raw, dict):
        for v in raw.values():
            ...
            if isinstance(v, list) and v and isinstance(v[0], dict):
                inner = v[0]; break
    obs = str(inner.get("observable", "KK graviton spin-2 Bulk-RS")) if isinstance(inner, dict) else "KK graviton spin-2 Bulk-RS"
...
class Constraint:
    ...
    observable = "KK graviton spin-2 Bulk-RS"
    ...
    def evaluate(self, point: ParameterPoint) -> ConstraintResult:
        result = evaluate_collider_rs_placeholder("KK graviton")
        return ConstraintResult(
            ...
            notes="Evaluation deferred: CR007 requires direct-search recast machinery not in core.",
