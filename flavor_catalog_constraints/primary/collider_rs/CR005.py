"""CR005 - Dilepton high-mass KK EW (placeholder)."""
    ...
    if isinstance(raw, dict):
        for v in raw.values():
            ...
            if isinstance(v, list) and v and isinstance(v[0], dict):
                inner = v[0]; break
    obs = str(inner.get("observable", "Dilepton high-mass KK EW")) if isinstance(inner, dict) else "Dilepton high-mass KK EW"
...
class Constraint:
    ...
    observable = "Dilepton high-mass KK EW"
    ...
    def evaluate(self, point: ParameterPoint) -> ConstraintResult:
        result = evaluate_collider_rs_placeholder("KK Z' resonance")
        return ConstraintResult(
            ...
            notes="Evaluation deferred: CR005 requires direct-search recast machinery not in core.",
