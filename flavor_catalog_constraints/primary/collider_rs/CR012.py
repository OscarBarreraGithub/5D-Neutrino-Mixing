"""CR012 - Diboson high-mass spin-1 resonance (placeholder)."""
    ...
    if isinstance(raw, dict):
        for v in raw.values():
            ...
            if isinstance(v, list) and v and isinstance(v[0], dict):
                inner = v[0]; break
    obs = str(inner.get("observable", "Diboson high-mass spin-1 resonance")) if isinstance(inner, dict) else "Diboson high-mass spin-1 resonance"
...
class Constraint:
    ...
    observable = "Diboson high-mass spin-1 resonance"
    ...
    def evaluate(self, point: ParameterPoint) -> ConstraintResult:
        result = evaluate_collider_rs_placeholder("diboson resonance")
        return ConstraintResult(
            ...
            notes="Evaluation deferred: CR012 requires direct-search recast machinery not in core.",
