"""CR006 - CC high-mass KK W' (placeholder)."""
    ...
    if isinstance(raw, dict):
        for v in raw.values():
            ...
            if isinstance(v, list) and v and isinstance(v[0], dict):
                inner = v[0]; break
    obs = str(inner.get("observable", "CC high-mass KK W'")) if isinstance(inner, dict) else "CC high-mass KK W'"
...
class Constraint:
    ...
    def evaluate(self, point: ParameterPoint) -> ConstraintResult:
        result = evaluate_collider_rs_placeholder("KK W' resonance")
        return ConstraintResult(
            ...
            notes="Evaluation deferred: CR006 requires direct-search recast machinery not in core.",
