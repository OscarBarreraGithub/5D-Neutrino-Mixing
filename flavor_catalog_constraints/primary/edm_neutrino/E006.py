"""E006 — Mercury-199 electric dipole moment.
...
Catalog sidecar
---------------
``flavor_catalog/processes/edm_neutrino/E006.yaml`` (schema-flex anchor:
...
class _Anchor:
    """Typed view over the ``E006.yaml`` anchor block (schema-flex)."""
...
def _build_anchor(raw) -> _Anchor:
    ...
    return _Anchor(
        raw=raw,
        observable=str(inner.get("observable", "Hg-199 EDM |d_Hg|")),
...
@register_constraint
class Constraint:
    """Catalogued Mercury-199 electric dipole moment constraint (process_id ``E006``)."""

    process_id = "E006"
    severity = Severity.INFO
    observable = "Hg-199 EDM |d_Hg|"
    ...
    def evaluate(self, point: ParameterPoint) -> ConstraintResult:
        result = evaluate_hadronic_edm_placeholder("Hg-199")
        return ConstraintResult(
            ...
            notes=(
                "Evaluation deferred: E006 is an EDM observable requiring "
