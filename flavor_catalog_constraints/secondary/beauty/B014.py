"""B014 - Excl b->dγ radiative (SECONDARY placeholder)."""
    ...
    if isinstance(raw, dict):
        for v in raw.values():
            ...
            if isinstance(v, list) and v and isinstance(v[0], dict):
                inner = v[0]; break
    obs = str(inner.get("observable", "Excl b->dγ radiative")) if isinstance(inner, dict) else "Excl b->dγ radiative"
...
class Constraint:
    ...
    observable = "Excl b->dγ radiative"
    ...
    def evaluate(self, point: ParameterPoint) -> ConstraintResult:
        ...
        return ConstraintResult(
            ...
            notes="Evaluation deferred: B014 SECONDARY placeholder.",
