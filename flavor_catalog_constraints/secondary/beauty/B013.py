"""B013 - Bs->φγ exclusive radiative (SECONDARY placeholder)."""
    ...
    if isinstance(raw, dict):
        for v in raw.values():
            ...
            if isinstance(v, list) and v and isinstance(v[0], dict):
                inner = v[0]; break
    obs = str(inner.get("observable", "Bs->φγ exclusive radiative")) if isinstance(inner, dict) else "Bs->φγ exclusive radiative"
...
class Constraint:
    ...
    observable = "Bs->φγ exclusive radiative"
    ...
    def evaluate(self, point: ParameterPoint) -> ConstraintResult:
        ...
        return ConstraintResult(
            ...
            notes="Evaluation deferred: B013 SECONDARY placeholder.",
