"""B007 - Rare electronic Bd/Bs->ee (SECONDARY placeholder)."""
    ...
    if isinstance(raw, dict):
        for v in raw.values():
            ...
            if isinstance(v, list) and v and isinstance(v[0], dict):
                inner = v[0]; break
    obs = str(inner.get("observable", "Rare electronic Bd/Bs->ee")) if isinstance(inner, dict) else "Rare electronic Bd/Bs->ee"
...
class Constraint:
    ...
    observable = "Rare electronic Bd/Bs->ee"
    ...
    def evaluate(self, point: ParameterPoint) -> ConstraintResult:
        ...
        return ConstraintResult(
            ...
            notes="Evaluation deferred: B007 SECONDARY placeholder.",
