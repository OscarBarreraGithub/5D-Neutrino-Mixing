"""K019 - LFV K_L semileptonic (SECONDARY placeholder)."""
    ...
    if isinstance(raw, dict):
        for v in raw.values():
            ...
            if isinstance(v, list) and v and isinstance(v[0], dict):
                inner = v[0]; break
    obs = str(inner.get("observable", "LFV K_L semileptonic")) if isinstance(inner, dict) else "LFV K_L semileptonic"
...
class Constraint:
    ...
    observable = "LFV K_L semileptonic"
    ...
    def evaluate(self, point: ParameterPoint) -> ConstraintResult:
        ...
        return ConstraintResult(
            ...
            notes="Evaluation deferred: K019 SECONDARY placeholder.",
