...
The current PDG live/API listings, edition 2026 and accessed on 2026-05-17,
...
post-2008 experimental update, improving the previous CDF limits by more than
...
implementation.  Nearby hits are neutral \(B_d/B_s\) mixing and unrelated
charged-lepton dipole code, for example \texttt{quarkConstraints/deltaf2.py:239}
and \texttt{quarkConstraints/deltaf2.py:922}, not this \(\Delta B=1\)
electronic leptonic observable.
