...
The PKA found no newer direct \(K_L\to e\mu\) branching-fraction limit in the
PDG 2025 \(K_L^0\) listing; the BNL E871 result remains the canonical bound.
Post-2008 work matters instead through model interpretation.  Buras et al.
...
implementation.  The adjacent code surfaces are a \(\mu\to e\gamma\) LFV
dipole check and quark-only \(\Delta F=2\) kaon mixing, which are not this
observable.
