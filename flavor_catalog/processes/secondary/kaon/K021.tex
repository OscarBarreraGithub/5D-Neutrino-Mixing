...
This is a \(\Delta S=1\), neutral-current LFV channel.  In an RS/anarchic
...
This Wave-8 entry is policy-tagged \textbf{SECONDARY}: it is a deferred
lepton-bulk RS scope extension with lower implementation priority than the
Wave-1--7 primary catalog, per the Wave-8 policy in
\texttt{flavor\_catalog/PRIORITY\_TIERS.md} when present and the orchestrator
runbook otherwise.
