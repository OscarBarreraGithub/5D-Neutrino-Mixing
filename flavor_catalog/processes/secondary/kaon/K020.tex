...
This Wave-8 entry is policy-tagged \textbf{SECONDARY}; see
\texttt{flavor\_catalog/PRIORITY\_TIERS.md} when present, with the Wave-8
prompt policy binding this draft.
...
K020 is a charged-kaon LFV companion to the neutral-kaon LFV channel K019.  At
...
\textbf{NO.}  The PKA searched \texttt{quarkConstraints/}, \texttt{qcd/},
