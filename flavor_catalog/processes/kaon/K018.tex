...
\(0.2125(47)\) for \(K_S\mu3\).  The auxiliary sidecar inputs record the FLAG
\(N_f=2+1+1\) normalization \(f_+(0)=0.9698(17)\) and the PDG-derived
\(|V_{us}|=0.22330(53)\); these are normalization inputs, not separate
measured \(K_{\ell3}\) rates.
