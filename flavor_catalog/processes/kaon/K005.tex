...
\subsection*{Process}
\textbf{Standard notation:} \(K_L \to \pi^0\nu\bar\nu\).  This entry covers the
...
\[
  ...
  \quad (90\%~{\rm CL}),
\]
from the 2026 PDG pdgLive S013R40 table, traced to
...
and zero signal-region events, yielding the same \(2.2\times10^{-9}\) limit.
...
\textbf{NO.}  The PKA searched the requested code areas, excluding
...
\textbf{HIGH.}  A production implementation would need a new \(s\to d\nu\bar\nu\)
