...
\[
  ...
  \quad (90\%~{\rm CL}),
\]
from the \(K_S^0\) particle listing, accessed 2026-05-16.  The supporting
sidecar values from \texttt{lhcb\_2020\_ksmumu\_arxiv.txt} show the LHCb
...
\texttt{supporting\_numeric\_values} entry from
\texttt{chobanova\_2018\_ksmumu\_susy\_arxiv.txt} gives the Standard Model
scale as approximately \(5\times10^{-12}\), so the present limit mainly bounds
large new-physics enhancements rather than precision SM-sized effects.
