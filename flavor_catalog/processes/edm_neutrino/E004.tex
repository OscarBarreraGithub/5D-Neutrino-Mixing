...
dipole moment of the neutron, cataloged in the \texttt{edm\_neutrino} family as
a hadronic EDM and CP-violation benchmark.  The process is flavor diagonal, but
it probes CP-odd quark EDMs, quark chromo-EDMs, the QCD \(\theta\) term, and
the Weinberg three-gluon operator.
...
fields at PSI.  The PDG table records this as \(<0.18\) in units of
\(10^{-25}\ e\,\mathrm{cm}\); see
...
PDG also lists the superseded Pendlebury et al. 2015 direct limit
\(|d_n|<3.0\times10^{-26}\ e\,\mathrm{cm}\) at \(90\%\) CL.
...
2020 \(1.8\times10^{-26}\ e\,\mathrm{cm}\) bound.  On the model side,
...
the neutron EDM induced by dimension-\(4\) and dimension-\(6\) gluonic CP
violation and the isovector quark chromo-EDM.
