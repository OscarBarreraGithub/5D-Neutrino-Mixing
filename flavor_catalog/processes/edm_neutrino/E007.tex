...
For \(^{225}\mathrm{Ra}\), the canonical Argonne direct limit is the Bishof
et al. result
\[
...
The earlier proof-of-principle Ra measurement gave
...
\[
  ...
  \quad (95\%~\mathrm{C.L.}).
\]
An independent Heidelberg-centered \(^{129}\mathrm{Xe}\) measurement gives
...
\(^{225}\mathrm{Ra}\) EDM measurement in 2015 and improved it in 2016 by a
factor of \(36\).  The 2016 Ra paper also records planned sensitivity at the
\(1\times10^{-28}\ e\,\mathrm{cm}\) statistical level with
\(4\times10^{-29}\ e\,\mathrm{cm}\) systematic uncertainty.  The deposited
Argonne program page states the physical motivation: \(^{225}\mathrm{Ra}\)
has a \(15\) day half-life, spin \(1/2\), and expected sensitivity to
T-odd, P-odd effects \(2\)--\(3\) orders of magnitude larger than
\(^{199}\mathrm{Hg}\).

For Xe, the 2019 comagnetometer measurements established \(10^{-27}\)
\(e\,\mathrm{cm}\)-level direct limits.  The DFG Heidelberg upgrade proposal
for 2021--2026 aims to improve the present \(1.5\times10^{-27}\ e\,\mathrm{cm}\)
limit by more than \(2\) orders of magnitude.  KU Leuven's 2023--2027
RaF/AcF molecular project is not a direct Ra-atom limit, but it is relevant
future context because embedding octupole-enhanced Ra or Ac nuclei in dipolar
molecules can enhance Schiff-moment sensitivity by several orders of
magnitude.
