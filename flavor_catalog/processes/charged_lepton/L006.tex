...
The current PDG 2026 muon listing, datablock S004MC, gives the canonical
effective-coupling limit
\[
  G_C/G_F < 0.0030 \qquad (90\%\ {\rm C.L.})
\]
for the stated \((V-A)\times(V-A)\) four-lepton effective Lagrangian.  The same
PDG datablock footnote records the underlying MACS/PSI probability limit from
Willmann et al.,
\[
...
Relative to the arXiv:0804.1954 era, the experimental bound itself has not
changed: PDG still uses the 1999 MACS/PSI result.  The main post-2008 movement
is prospective.  The Snowmass 2021 whitepaper frames MACE as a next-generation
search intended to improve sensitivity by more than two orders of magnitude,
and the 2024 MACE conceptual design targets conversion probabilities beyond
the \(10^{-13}\) level.  On the theory side, recent EFT work separates
\(\Delta L_\mu=-\Delta L_e=2\) operators from ordinary one-unit LFV and notes
