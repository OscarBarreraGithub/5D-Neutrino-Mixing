...
\texttt{T017.yaml}.  The PDG 2025 \(Z\)-boson listing quotes the
charge-summed upper limit
\[
...
level.  CMS later performed a Run-2 search covering all three charged-lepton
flavor pairs in one analysis, providing an independent 2025 check of the
\(\mu\tau\) channel.  Future-factory studies also changed the context:
