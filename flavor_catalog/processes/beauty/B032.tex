...
\texttt{references/B032/hflav\_dec2025\_btopik\_values.txt}.  In HFLAV units of
\(10^{-5}\),
\[
\begin{array}{c|c}
{\rm mode} & {\cal B} \\
...
\end{array}
\]
The same HFLAV snapshot gives direct asymmetries in percent:
\[
A_{CP}(K^0_S\pi^+)=-2.67\pm0.87,\quad
A_{CP}(K^+\pi^0)=+2.7\pm1.2,\quad
...
and Belle II added 2024 measurements of all four \(K\pi\) branching fractions
and direct asymmetries.  Belle II also measured \(B^0\to K_S^0\pi^0\)
...
\texttt{tests/} returned exit code 1.  The modern policy surface lists only
