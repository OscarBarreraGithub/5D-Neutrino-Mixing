...
\texttt{flavor\_catalog/references/B026/hflav\_ckm2025\_rdrds.txt}:
\[
  R_{D^*}=0.281\pm0.011 .
\]
...
The 2008 CFW/Perez-Randall-era baseline predates the \(R_D^{(*)}\) anomaly
program.  The post-2008 experimental sequence starts with BaBar's 2012 and
2013 excess in \(B\to D^{(*)}\tau\nu\), followed by Belle hadronic-tag,
tau-polarization, and semileptonic-tag measurements, LHCb muonic-tau and
three-prong-tau measurements, and Belle II semileptonic-tag plus CKM-2025
hadronic-tag inputs.  HFLAV now performs a correlated average over these
measurements rather than comparing one experiment to one SM number.  On the SM
side, \(B\to D^*\ell\nu\) form-factor theory changed materially after 2008:
HFLAV cites the 2012 benchmark prediction, the 2021 FNAL/MILC nonzero-recoil
lattice calculation, 2023 HPQCD and JLQCD lattice results, and FLAG 2024
summary inputs.  The residual tension is therefore tied to correlated
experimental averaging and form-factor conventions, not to a missing basic SM
prediction.
...
\texttt{belle2017\_arxiv1612\_00529.txt},
\texttt{belle2018\_arxiv1709\_00129.txt},
\texttt{belle2019\_arxiv1910\_05864.txt},
\texttt{lhcb2023\_arxiv2302\_02886.txt},
\texttt{lhcb2023\_arxiv2305\_01463.txt},
\texttt{lhcb2025\_arxiv2406\_03387.txt},
\texttt{belleii2024\_arxiv2401\_02840.txt},
