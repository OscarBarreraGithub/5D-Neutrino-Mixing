...
\[
  R_K = 0.994\pm0.090,
\]
from LHCb's \(0.994^{+0.090}_{-0.082}{}^{+0.029}_{-0.027}\) measurement.  For
the central bin \(1.1<q^2<6.0\,{\rm GeV}^2/c^4\), HFLAV quotes
\[
  R_K = 0.947\pm0.047,
\]
combining LHCb \(0.949^{+0.042}_{-0.041}\pm0.022\) with CMS
\(0.78^{+0.46}_{-0.23}{}^{+0.09}_{-0.05}\).  HFLAV also records a Belle-only
full-\(q^2\) ratio \(1.08\pm0.16\).  Local snapshots are
...
reported a \(3.1\sigma\) tension with the SM.  The later LHCb simultaneous
\(R_K\)/\(R_{K^*}\) analysis using \(9\,{\rm fb}^{-1}\) superseded that result
and found the four LFU measurements compatible with the SM.  HFLAV Dec. 2025
therefore treats the charged \(R_K\) bins as SM-consistent averages.  On the
theory side, Bordone--Isidori--Pattori established the ratio as a clean probe
once radiative corrections and experimental cuts are handled consistently.
