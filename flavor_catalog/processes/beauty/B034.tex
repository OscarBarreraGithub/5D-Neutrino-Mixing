...
\]
The same combined values appear in the LHCb 2023 CDS record.  As contextual
rate information for the channel, HFLAV May 2024 quotes
\[
  {\cal B}(B_s^0\to\phi\phi)=(1.85\pm0.14)\times 10^{-5}.
\]
Local snapshots are in \texttt{flavor\_catalog/references/B034/}, accessed on
2026-05-16.
...
\(\phi_s=-0.17\pm0.15\pm0.03\ {\rm rad}\).  The 2019 update used
\(5.0\,{\rm fb}^{-1}\), about 9000 signal decays, and reported
\(\phi_s^{s\bar{s}s}=-0.073\pm0.115\pm0.027\ {\rm rad}\) with
\(|\lambda|=0.99\pm0.05\pm0.01\).  The 2023 precision measurement used
\(6\,{\rm fb}^{-1}\) at \(13\,{\rm TeV}\), giving
\(\phi_s^{s\bar{s}s}=-0.042\pm0.075\pm0.009\ {\rm rad}\) and
\(|\lambda|=1.004\pm0.030\pm0.009\) before combination.  The combined LHCb
result remains consistent with CP conservation and Standard Model expectations.
