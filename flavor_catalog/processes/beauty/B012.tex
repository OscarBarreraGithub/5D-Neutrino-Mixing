...
(\texttt{babar\_2009\_btokstargamma}); Belle reported \(3.1\sigma\) evidence
for isospin violation in 2017 (\texttt{belle\_2017\_isospin\_cp}); LHCb
observed photon polarization in \(b\to s\gamma\) at \(5.2\sigma\) using
\(B^\pm\to K^\pm\pi^\mp\pi^\pm\gamma\)
(\texttt{lhcb\_2014\_photon\_polarization}); and Belle II added 2019--2022
