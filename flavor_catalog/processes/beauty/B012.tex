...
The same HFLAV snapshot gives
\(\Delta_{0+}(B\to K^*\gamma)=0.059\pm0.014\) and
\(A_{CP}(B\to K^*\gamma)=-0.004\pm0.011\).  The PDG 2025 pdgLive
time-dependent average is
\[
...
Since the arXiv:0804.1954 flavor-baseline era, BaBar produced a high-statistics
branching-fraction, direct-CP, and isospin-asymmetry measurement in 2009; Belle
reported \(3.1\sigma\) evidence for isospin violation in 2017; LHCb observed
photon polarization in \(b\to s\gamma\) at \(5.2\sigma\) using
\(B^\pm\to K^\pm\pi^\mp\pi^\pm\gamma\); and Belle II added 2019--2022
\(B\to K^*\gamma\) measurements now entering HFLAV.  PDG 2025 also includes a
new Belle/Belle II input in the \(S_{K^*\gamma}\) average.
