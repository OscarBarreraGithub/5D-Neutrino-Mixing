...
adjacent RS context but are spin-2 and are not the canonical CR012 spin-1
value.  In the collider-RS catalog this is the direct diboson resonance entry
for electroweak KK vectors and generic heavy vector partners.
...
\texttt{scanParams/scan.py:523} starts the unrelated \(\mu\to e\gamma\) LFV
