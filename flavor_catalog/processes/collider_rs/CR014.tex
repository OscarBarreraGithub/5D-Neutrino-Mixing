...
higher than the Standard-Model reference rate but compatible within about two
standard deviations, so the inclusive four-top result is currently a
...
\texttt{quarkConstraints/scan.py:377}--\texttt{quarkConstraints/scan.py:441}
