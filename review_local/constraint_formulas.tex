...
\begin{align}
\langle Q_1^{\rm VLL}\rangle &= \tfrac{2}{3}\,f_M^2 m_M\,B_1, \\
\langle Q_4^{\rm LR}\rangle &= \Big(\tfrac{1}{6}\,r_\chi+\tfrac14\Big)f_M^2 m_M\,B_4, &
\langle Q_5^{\rm LR}\rangle &= \Big(\tfrac{1}{2}\,r_\chi+\tfrac{1}{12}\Big)f_M^2 m_M\,B_5,
\end{align}
