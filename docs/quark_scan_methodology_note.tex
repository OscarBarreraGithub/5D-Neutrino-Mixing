...
conventions in Appendix~\ref{app:input-audits}, the p50 value is
$47.26$~TeV at $\gs=3$; the CFW no-UV-boundary-term RS marker at the same
convention is $10.5$~TeV, while its default $\gs\simeq6$ marker is
$21$~TeV (\S\ref{sec:robust-cfw}).  The residual is attributable to newer
...
All numerical claims in this note map to the artifact manifest at
