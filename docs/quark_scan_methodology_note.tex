...
and $O_1^{\mathrm{VRR}}$, but the left-right entries are the scalar
$O_4^{\mathrm{LR}}$, $O_5^{\mathrm{LR}}$ operators paired with the
...
$C_5\mapsto-0.895\,C_4+0.854\,C_5$ in the code basis.  The crossed
threshold sequence is $n_f=6\to5\to4$ at
$m_t=163.5\,\mathrm{GeV}$ and $m_b=4.18\,\mathrm{GeV}$; the charm
...
is $2.368$.  This is a factor $4.43$ increase, so the Wilson running is
