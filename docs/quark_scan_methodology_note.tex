...
%% M_KK^min documented in docs/archive/phase_logs/phase2_h5_signoff.md:90-101 and
...
\path{docs/archive/phase_logs/phase2_h5_signoff.md:90-101}). Two physically
...
\path{docs/archive/phase_logs/phase2_h5_signoff.md} and the Wilson-RG sign-off
in \path{docs/archive/phase_logs/phase2_h6_signoff.md}.  The benchmark
$\eK$ ratio shift is the product $6.2388\times3.6052=22.49$, which is
far above the 10\% rerun threshold in
\path{docs/archive/superseded/paper_execution_decisions.md}.  The post-audit rerun report is
\path{docs/archive/phase_logs/invalidation_gate_rerun.md}; it records the nine
