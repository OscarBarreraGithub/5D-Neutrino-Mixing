...
cancels the leading $T$ and protects $Z\to b\bar b$, relieving the oblique floor from
$\sim$16\,TeV to $\sim$6\,TeV (Table~\ref{tab:oblique}). But $\epsK$ is a
color-octet KK-gluon left--right operator, a singlet under the electroweak
custodial group; it is \emph{untouched} by custodialization. After custodial, the
$\epsK$ wall ($\sim$9--24\,TeV) is the binding constraint. Custodial buys
electroweak viability, and nothing on flavor.
...
\bibitem{CGHNP} M.~S.~Carena \emph{et al.}, \emph{Precision electroweak data and
unification of couplings in warped extra dimensions} and follow-ups (2008-era $S,T$
fit, used as the historical reference ellipse).
...
\bibitem{Blanke} M.~Blanke \emph{et al.}, $\Delta F=2$ observables and fine-tuning
in the RS model (KK-gluon $\epsK$ analysis).
